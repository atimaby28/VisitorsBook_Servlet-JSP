...
<head>
    <meta charset="UTF-8">
    <title>Visitor's Book - 글작성</title>
    <meta charset="utf-8">
        ...
        $(document).ready(function () {
            $("#registerBtn").click(function () {
                if (!$("#visitorid").val()) {
                    ...
                    $("#writeform").attr("action", "/visitorsbook2_jsp/visitorsbook/articlewrite.jsp").submit();
                }
            });
        });
    </script>
        ...
        <div class="col-lg-8 mx-auto">
            ...
            <form id="writeform" class="text-left mb-3" method="post" action="">
                <div class="form-group">
                    <label for="visitorid">작성자ID:</label>
                    <input type="text" class="form-control" id="visitorid" name="visitorid" placeholder="작성자ID...">
                </div>
                <div class="form-group">
